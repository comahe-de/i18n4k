...
class NameToIndexMapperNumbersFrom0Test {
    @Test
    fun testIndexes() {
        val m = NameToIndexMapperNumbersFrom0
        assertEquals(0, m.getNameIndex("0"))
        assertEquals(1, m.getNameIndex("1"))
        assertEquals(2, m.getNameIndex("2"))
        assertEquals(3, m.getNameIndex("3"))
        assertEquals(4, m.getNameIndex("4"))
        assertEquals(5, m.getNameIndex("5"))
        assertEquals(6, m.getNameIndex("6"))
        assertEquals(7, m.getNameIndex("7"))
        assertEquals(8, m.getNameIndex("8"))
        assertEquals(9, m.getNameIndex("9"))
    }
    ...
    fun testWrongNames() {
        ...
        assertFailsWith(IllegalArgumentException::class) { m.getNameIndex("10") }
