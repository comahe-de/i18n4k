 ...
 * - `VALUE_REGEX`
 *    - When the value is prefixed by "regex#", it is seen as regular repression, e.g.
 *      `regex#([A-Z])\w+`
 *    - If the regex matches the value of the parameter, the corresponding text (TEXT_REGEX) is
 *      selected
 * - `TEXT*`:
