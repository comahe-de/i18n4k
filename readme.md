...
**Lastest release version:** 0.11.2
...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-js:0.11.2")
}
```
...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-jvm:0.11.2")
}
```
...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-android:0.11.2")
}
```
...
[badge-version]:https://img.shields.io/badge/version-0.11.2-blueviolet?style=flat
