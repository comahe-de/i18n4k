...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-js:0.1.1-SNAPSHOT")
}
```
...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-jvm:0.1.1-SNAPSHOT")
}
```
...
[badge-version]:https://img.shields.io/badge/version-0.1.1-blueviolet?style=flat
