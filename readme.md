...
```kotlin
dependencies {
    implementation("de.comahe.i18n4k:i18n4k-core-js:0.2.0")
}
```
...
[badge-version]:https://img.shields.io/badge/version-0.2.0-blueviolet?style=flat
